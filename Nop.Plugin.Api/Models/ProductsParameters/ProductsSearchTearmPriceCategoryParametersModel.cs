...
namespace Nop.Plugin.Api.Models.ProductsParameters
{
    ...
    [ModelBinder(typeof(ParametersModelBinder<ProductsSearchTearmPriceCategoryParametersModel>))]
    public class ProductsSearchTearmPriceCategoryParametersModel : BaseProductsParametersModel
    {
        ...
        /// <summary>
        ///     Price From to search the product
        /// </summary>
        [JsonProperty("price-from")]
        public int PriceFrom { get; set; }
        
        /// <summary>
        ///     Price To to search the product
        /// </summary>
        [JsonProperty("price-to")]
        ...
        /// <summary>
        ///     list of category ids to search the product
        /// </summary>
