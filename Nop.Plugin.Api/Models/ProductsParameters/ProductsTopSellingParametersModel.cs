...
namespace Nop.Plugin.Api.Models.ProductsParameters
{
    ...
    [ModelBinder(typeof(ParametersModelBinder<ProductsTopSellingParametersModel>))]
    public class ProductsTopSellingParametersModel : BaseProductsParametersModel
    {
        /// <summary>
        ...
        /// <summary>
        ///     how much products to return to frontend
        /// </summary>
        [JsonProperty("product_to_return")]
        public int? ProductToReturn { get; set; }
    }
}
