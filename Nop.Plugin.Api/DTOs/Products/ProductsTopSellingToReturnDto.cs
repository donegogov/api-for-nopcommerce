...
namespace Nop.Plugin.Api.DTO.Products
{
    ...
    public class ProductTopSellingToReturnDto : BaseDto
    {
        ...
        /// <summary>
        ///     How much times is this product ordered
        /// </summary>
        [JsonProperty("product_total_order_items_count")]
        public int ProductTotalOrderItemsCount { get; set; }
